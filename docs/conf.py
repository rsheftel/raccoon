...
# -*- coding: utf-8 -*-
#
# Raccoon documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Raccoon.tex', 'Raccoon Documentation',
   'Ryan Sheftel', 'manual'),
]
...
man_pages = [
    ('index', 'raccoon', 'Raccoon Documentation',
     ['Ryan Sheftel'], 1)
]
...
texinfo_documents = [
  ('index', 'Raccoon', 'Raccoon Documentation',
   'Ryan Sheftel', 'Raccoon', 'One line description of project.',
   'Miscellaneous'),
]
