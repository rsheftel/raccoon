...
def test_set_cell():
    actual = rc.DataFrame(
        {"a": [1, 2, 3], "b": [4, 5, 6], "c": [7, 8, 9]}, index=[10, 11, 12], columns=["a", "b", "c"], sort=False
    )
    ...
    actual.set(1, "a", -100)
    assert actual.data == [
        [11, 2, 3, None, None, -100],
        [4, 55, 6, 14, None, None],
        [13, 8, 9, None, None, None],
        [None, None, None, 88, None, None],
        [None, None, None, None, 999, None],
    ]
...
def test_set_cell_sorted():
    actual = rc.DataFrame(
        {"a": [1, 2, 3], "b": [4, 5, 6], "c": [7, 8, 9]}, index=[10, 12, 13], columns=["a", "b", "c"], sort=True
    )
...
def test_set_row():
    actual = rc.DataFrame({"a": [1, 3], "b": [4, 6], "c": [7, 9]}, index=[10, 12], columns=["a", "b", "c"], sort=True)
...
def test_set_column_sorted():
    actual = rc.DataFrame(
        {"a": [1, 2, 3], "b": [4, 5, 6], "c": [7, 8, 9]}, index=[10, 11, 12], columns=["a", "b", "c"], sort=True
    )
...
def test_set_col_index_subset():
    ...
    assert actual.data == [
        [11, 2, 33, None, None, None, None],
        [44, 55, 66, None, None, None, None],
        [7, 8, 120, 130, 140, None, None],
        [None, None, None, None, "zoo", "boo", "hoo"],
    ]
    ...
    # by boolean list
    actual = rc.DataFrame(
        {"c": [1, 2], "a": [4, 5], "b": [7, 8]}, index=["first", "second"], columns=["a", "b", "c"], sort=False
    )
...
def test_set_col_index_subset_sorted():
    ...
    assert actual.data == [
        [-120, -130, None, -140, 2, 33, None, None, None],
    ...
    actual.set(columns="z", indexes=[14, 15, 16], values=["zoo", "boo", "hoo"])
    assert actual.data == [
        [-120, -130, None, -140, 2, 33, None, None, None, None],
    ...
    # by boolean list
    actual = rc.DataFrame(
        {"c": [1, 2], "a": [4, 5], "b": [7, 8]}, index=["first", "second"], columns=["a", "b", "c"], sort=True
    )
    actual.set(columns="c", indexes=[False, True], values=[99])
    assert actual.data == [[4, 5], [7, 8], [1, 99]]
...
def test_append_row():
    ...
    expected = rc.DataFrame(
        {"a": [1, 3, 10], "b": [4, 6, None], "c": [7, 9, 13]}, index=[10, 12, 14], columns=["a", "b", "c"]
    )
    ...
    expected = rc.DataFrame(
        {"a": [1, 3, 10, 14], "b": [4, 6, None, 15], "c": [7, 9, 13, None], "d": [None, None, None, 100]},
        index=[10, 12, 14, 16],
        columns=["a", "b", "c", "d"],
    )
    assert_frame_equal(actual, expected)
...
def test_append_rows():
    ...
    expected = rc.DataFrame(
        {"a": [1, 3, 10, 11], "b": [4, 6, None, None], "c": [7, 9, 13, 14]},
        index=[10, 12, 14, 15],
        columns=["a", "b", "c"],
    )
    assert_frame_equal(actual, expected)
    ...
    expected = rc.DataFrame(
        {
            "a": [1, 3, 10, 11, 14, 15],
            "b": [4, 6, None, None, 15, 16],
            "c": [7, 9, 13, 14, None, None],
            "d": [None, None, None, None, 100, 101],
        },
        index=[10, 12, 14, 15, 16, 17],
        columns=["a", "b", "c", "d"],
    )
    assert_frame_equal(actual, expected)
